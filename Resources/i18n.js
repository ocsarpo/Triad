(function (root, factory) {
  ...
  const CHROME = {
    ...
    '공유 보드 단계 미기록': 'Shared-board step not recorded',
    '공유 보드 패킷 준비 실패': 'Shared-board packet prep failed',
    ...
    '상호 토론 완료': 'Debate complete',
    '교차 검토 완료': 'Cross-review complete',
    '상호 토론 시작': 'Debate started',
    '교차 검토 시작': 'Cross-review started',
  ...
  const MSG = {
    ...
    welcomeText: { en: 'In independent mode, send without tags and both AIs respond. In agent collaboration, the lead AI asks the other AI when needed and continues with the answer. Debate and cross-review are also available. Reference project files with @document.', ko: '독립 실행에서는 태그 없이 보내면 두 AI가 응답합니다. 에이전트 협업에서는 시작 AI가 필요할 때 상대 AI에게 질문하고 답을 돌려받아 작업을 계속합니다. 상호 토론과 교차 검토도 사용할 수 있습니다. @문서로 프로젝트 파일을 참조할 수 있습니다.' },
    ...
    traceStarting: { en: 'Starting: {label}', ko: '{label} 시작' },
    ...
    phaseProposal: { en: 'Draft proposal', ko: '제안 작성' },
    phaseVerdict: { en: 'Focused review', ko: '좁은 검토' },
    phaseResolve: { en: 'Resolve disputes', ko: '이견 해결' },
    phaseDecision: { en: 'Final decision', ko: '최종 결정' },
